...
static int current_user_index;
    public static void main(String[] args){
        //------admins-------
        admin_mail_id.add("qwerty21@gmail.com");
        admin_password.add(12345);
        admin_mail_id.add("20cs07@kpriet.ac.in");
        admin_password.add(12345);
        //----learner--------
        learner_id.add(10000);
        learner_user_id.add("qwerty21");
        learner_deposit.add(1500);
        learner_password.add(12345);
        //-----books---------
        book_type.add("Nonfiction Books");
        book_name.add("Flowers in SunShine");
        book_id.add(100);
        book_count.add(10);
        book_price.add(200);

        book_type.add("Fiction Books");
        book_name.add("The White Tiger");
        book_id.add(101);
        book_count.add(15);
        book_price.add(900);        

        book_type.add("Food");
        book_name.add("Farm by Fingers");
        book_id.add(102);
        book_count.add(9);
        book_price.add(850);     

        book_type.add("History");
        book_name.add("Discovery of India by Jawaharlal Nehru");
        book_id.add(103);
        book_count.add(13);
        book_price.add(1850);
        ...
        book_name.add("Seven Decades Of Independent India: Ideas And Reflections");
        book_id.add(105);
        book_count.add(8);
        book_price.add(2700);
        welcome();
